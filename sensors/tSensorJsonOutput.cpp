...
static tSensorJsonOutput* tSensorJsonOutput::Instance;



#if CONFIG_SENSORS_JSON_OUTPUT

doFormatJSON tSensorJsonOutput::getJSONFormatFunction(uint8_t SensorType, uint8_t apiVersion)
{
    switch (SensorType)
    {
...
tSensorJsonOutput sensorJsonOutput;
